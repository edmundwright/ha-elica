...
from custom_components.elica.data import DeviceInfo
...
class ElicaIntegrationDataUpdateCoordinator(
    ...
    async def _async_update_data(self) -> dict[str, DeviceInfo]:
        ...
        try:
            return await self.config_entry.runtime_data.client.get_info_on_devices()
