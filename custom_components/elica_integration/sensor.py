"""Sensor platform for elica_integration."""
...
class ElicaIntegrationSensor(ElicaIntegrationEntity, SensorEntity):
    """elica_integration Sensor class."""
